"""
Script para probar el Agente Fiscal con un caso real
"""
...
def main():
    ...
    try:
        # Analizar el caso
        analysis = prosecutor.investigate_case(test_case)
        
        # Mostrar resultados
        console.print("\n[bold green]Análisis completado:[/bold green]")
        # Si analysis es un string, parsearlo como JSON, si no, usarlo directamente
